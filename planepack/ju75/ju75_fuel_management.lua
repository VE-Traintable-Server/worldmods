...
function ju75.contains(table, val)
...
function ju75.loadFuel(self, player_name)
    ...
    local fuel = ju75.contains(airutils.fuel, item_name)
    if fuel then
...
function ju75.consumptionCalc(self, accel)
