...
local function get_liquid_count(stack)
	...
	if is_filled_bucket(stack) then
		...
		liquid_count = 1
	--[[ elseif minetest.get_modpath("technic") and technic.cans[stack:get_name()] then --this is a patch by wsor to work around this mod being dumb and depending on smackers  technic
