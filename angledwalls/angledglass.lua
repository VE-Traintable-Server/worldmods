...
-- cdh addition
--concrete glass
angledglass.register_glass("_concrete_blue_glass", "default:stone",
		{choppy = 2, oddly_breakable_by_hand = 2, stone =1},
		{"scifi_nodes_octbl.png", "basic_materials_concrete_block.png"},
		"Concrete Blue Glass",
		default.node_sound_glass_defaults())

angledglass.register_glass("_concrete_green_glass", "default:stone",
		{choppy = 2, oddly_breakable_by_hand = 2, stone =1},
		{"scifi_nodes_octgrn.png", "basic_materials_concrete_block.png"},
		"Concrete Green Glass",
		default.node_sound_glass_defaults())
		
angledglass.register_glass("_concrete_orange_glass", "default:stone",
		{choppy = 2, oddly_breakable_by_hand = 2, stone =1},
		{"scifi_nodes_octrng.png", "basic_materials_concrete_block.png"},
		"Concrete Orange Glass",
		default.node_sound_glass_defaults())
		
angledglass.register_glass("_concrete_purple_glass", "default:stone",
		{choppy = 2, oddly_breakable_by_hand = 2, stone =1},
		{"scifi_nodes_octppl.png", "basic_materials_concrete_block.png"},
		"Concrete Purple Glass",
		default.node_sound_glass_defaults())

-- blast concrete glass
angledglass.register_glass("_blast_resistant_concrete_blue_glass", "default:stone",
		{choppy = 2, oddly_breakable_by_hand = 2, stone =1},
		{"scifi_nodes_octbl.png", "technic_blast_resistant_concrete_block.png"},
		"Blast-Resistant Concrete Blue Glass",
		default.node_sound_glass_defaults())

angledglass.register_glass("_blast_resistant_concrete_green_glass", "default:stone",
		{choppy = 2, oddly_breakable_by_hand = 2, stone =1},
		{"scifi_nodes_octgrn.png", "technic_blast_resistant_concrete_block.png"},
		"Blast-Resistant Concrete Green Glass",
		default.node_sound_glass_defaults())

angledglass.register_glass("_blast_resistant_concrete_orange_glass", "default:stone",
		{choppy = 2, oddly_breakable_by_hand = 2, stone =1},
		{"scifi_nodes_octrng.png", "technic_blast_resistant_concrete_block.png"},
		"Blast-Resistant Concrete Orange Glass",
		default.node_sound_glass_defaults())

angledglass.register_glass("_blast_resistant_concrete_purple_glass", "default:stone",
		{choppy = 2, oddly_breakable_by_hand = 2, stone =1},
		{"scifi_nodes_octppl.png", "technic_blast_resistant_concrete_block.png"},
		"Blast-Resistant Concrete Purple Glass",
		default.node_sound_glass_defaults())

-- cement glass
angledglass.register_glass("_cement_blue_glass", "default:stone",
		{choppy = 2, oddly_breakable_by_hand = 2, stone =1},
		{"scifi_nodes_octbl.png", "basic_materials_cement_block.png"},
		"Cement Blue Glass",
		default.node_sound_glass_defaults())

angledglass.register_glass("_cement_green_glass", "default:stone",
		{choppy = 2, oddly_breakable_by_hand = 2, stone =1},
		{"scifi_nodes_octgrn.png", "basic_materials_cement_block.png"},
		"Cement Green Glass",
		default.node_sound_glass_defaults())

angledglass.register_glass("_cement_orange_glass", "default:stone",
		{choppy = 2, oddly_breakable_by_hand = 2, stone =1},
		{"scifi_nodes_octrng.png", "basic_materials_cement_block.png"},
		"Cement Orange Glass",
		default.node_sound_glass_defaults())

angledglass.register_glass("_cement_purple_glass", "default:stone",
		{choppy = 2, oddly_breakable_by_hand = 2, stone =1},
		{"scifi_nodes_octppl.png", "basic_materials_cement_block.png"},
		"Cement Purple Glass",
		default.node_sound_glass_defaults())
-- clay glass
angledglass.register_glass("_white_clay_blue_glass", "default:stone",
		{choppy = 2, oddly_breakable_by_hand = 2, stone =1},
		{"scifi_nodes_octbl.png", "baked_clay_white.png"},
		"White Clay Blue Glass",
		default.node_sound_glass_defaults())

angledglass.register_glass("_white_clay_green_glass", "default:stone",
		{choppy = 2, oddly_breakable_by_hand = 2, stone =1},
		{"scifi_nodes_octgrn.png", "baked_clay_white.png"},
		"White Clay Green Glass",
		default.node_sound_glass_defaults())

angledglass.register_glass("_white_clay_orange_glass", "default:stone",
		{choppy = 2, oddly_breakable_by_hand = 2, stone =1},
		{"scifi_nodes_octrng.png", "baked_clay_white.png"},
		"White Clay Orange Glass",
		default.node_sound_glass_defaults())

angledglass.register_glass("_white_clay_purple_glass", "default:stone",
		{choppy = 2, oddly_breakable_by_hand = 2, stone =1},
		{"scifi_nodes_octppl.png", "baked_clay_white.png"},
		"White Clay Purple Glass",
		default.node_sound_glass_defaults())
